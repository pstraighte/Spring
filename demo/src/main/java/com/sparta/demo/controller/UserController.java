...
public class UserController {
    ...
    public ResponseEntity<ApiResponseDto> signUp(@Valid @RequestBody AuthRequestDto requestDto) {//username, password 받아와서 Body에 저장
    ...
    public ResponseEntity<ApiResponseDto> login(@RequestBody AuthRequestDto loginRequestDto, HttpServletResponse response) {
        ...
        //JWT 생성 및 쿠키에 저장 후 Response-header 객체에 추가
